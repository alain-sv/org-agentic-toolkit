...
class TestCompileDocument:
    ...
    def test_compile_basic(self, tmp_path):
        ...
        (org_root / ".agent" / "skills" / "git").mkdir(parents=True)
        (org_root / ".agent" / "skills" / "git" / "skill.md").write_text("# Git Skills")
...
""")
        ...
        (personal / "memory" / "personal-context.md").write_text("# Personal Context")
