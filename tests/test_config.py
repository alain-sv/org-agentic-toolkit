...
class TestLoadTargetsYaml:
    ...
    def test_load_valid_targets(self, tmp_path):
        ...
        targets = {"targets": {"cursor": ".cursorrules", "windsurf": ".windsurfrules"}}
...
class TestValidateInheritsStructure:
    ...
    def test_valid_structure(self):
        ...
        config = {
            "org_root": "../..",
            "skills": {"universal": ["git"], "languages": {"python": ["django"]}},
            "personas": ["backend-developer"],
        }
    ...
    def test_missing_org_root(self):
        ...
        config = {"skills": {"universal": ["git"]}, "personas": ["backend-developer"]}
    ...
    def test_missing_skills(self):
        ...
        config = {"org_root": "../..", "personas": ["backend-developer"]}
...
class TestGetPersonasFromConfig:
    ...
    def test_get_personas(self):
        ...
        config = {"personas": ["backend-developer", "frontend-developer"]}
